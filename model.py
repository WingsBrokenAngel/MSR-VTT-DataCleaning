...
class SGRU():
    ...
    def construct_train_model(
        ...
        self.train_gen_words = tf.argmax(self.prob_dist, axis=-1)
        ...
        # The loss_logits here is probability for each caption which is guided by different annotation.
        self.loss_logits = loss_logits * self.gamma + lens_logits * (1 - self.gamma)
        self.loss = (tf.reduce_sum(xe_loss * self.loss_logits) / 
